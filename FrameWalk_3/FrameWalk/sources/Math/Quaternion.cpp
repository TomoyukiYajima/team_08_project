...
float Quaternion::Length() const { return (float)std::sqrt(Dot(*this, *this)); }

Quaternion Quaternion::Slerp(
	const Quaternion & value1, const Quaternion & value2, float amount)
{
...
Quaternion & operator/=(Quaternion & q, float s) { return q *= 1.0f / s; }
