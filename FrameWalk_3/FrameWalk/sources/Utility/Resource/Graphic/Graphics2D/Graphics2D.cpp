...
void Graphics2D::draw_sprite(int id, const Vector2 & position, const Vector2 & center, int scaleX, int scaleY, int angle, int Trans, int Turn)
{
	sprite_map_[id].draw(position, center, scaleX, scaleY, angle, Trans, Turn);
}
...
void Graphics2D::draw_sprite(int id, int animation, float timer, const Vector2 & position, const Vector2 & center, const Vector2 & scale, float rotation)
{
	sprite_map_[id].draw(animation, timer, position, center, scale, rotation);
}
...
Vector2 Graphics2D::get_sprite_size(int id)
{
	return sprite_map_[id].get_sprite_size();
}
